...
// old postsController testing RDS postges queries
// use this as a model for testing queries to users table in RDS
...
// describe.skip('posts retrived for specific user', () => {
...
// describe.skip('add post for specific user', () => {
...
// describe.skip('add user post with error triggers error handler', () => {
//   const queryMock = jest.spyOn(db, 'query');
...
// describe.skip('Update post successful', () => {
//   const queryMock = jest.spyOn(db, 'query');
...
// describe.skip('Delete post successful', () => {
